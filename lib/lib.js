...
(function()
{
    ...
    function pegaMesNaData(doc)
    {
        ...
        {
            var idMes = (doc.students[i].registered) ? doc.students[i].registered.getUTCMonth() : new Date().getUTCMonth();
        ...
        {
            meses[h].porcentagem = retornaPorcentagem(totalAlunos, meses[h].contador)
        }
